#--------------------------------------------
## Study 2 Simulation Replication Function ##
#--------------------------------------------
...
Study2SimRep <- function(relX, relU, relY, corxu, r.sq, n, replics, var.names){
  ...
  ###### for debugging #####
  ## relX=0.9;relU=0.9;relY=0.9;corxu=0.4;r.sq=0.5;n=500;reps=1000;var.names=out.names;i <- 1
  ##########################
